...
bool WebAssemblyFastISel::selectLoad(const Instruction *I) {
  ...
  case MVT::i1:
  case MVT::i8:
    Opc = WebAssembly::LOAD8_U_I32_handle;
    RC = &WebAssembly::I32RegClass;
    break;
  case MVT::i16:
    Opc = WebAssembly::LOAD16_U_I32_handle;
    RC = &WebAssembly::I32RegClass;
    break;
  case MVT::i32:
    Opc = WebAssembly::LOAD_I32_handle;
    RC = &WebAssembly::I32RegClass;
    break;
  case MVT::i64:
    Opc = WebAssembly::LOAD_I64_handle;
    RC = &WebAssembly::I64RegClass;
    break;
  case MVT::f32:
    Opc = WebAssembly::LOAD_F32_handle;
    RC = &WebAssembly::F32RegClass;
    break;
  case MVT::f64:
...
bool WebAssemblyFastISel::selectStore(const Instruction *I) {
  ...
  case MVT::i1:
    ...
    LLVM_FALLTHROUGH;
  case MVT::i8:
    Opc = WebAssembly::STORE8_I32_handle;
    break;
  case MVT::i16:
    Opc = WebAssembly::STORE16_I32_handle;
    break;
  case MVT::i32:
    Opc = WebAssembly::STORE_I32_handle;
    break;
  case MVT::i64:
    Opc = WebAssembly::STORE_I64_handle;
    break;
  case MVT::f32:
    Opc = WebAssembly::STORE_F32_handle;
    break;
  case MVT::f64:
